<template>
  <div
    class="boss-1"
    v-show="status == 1"
    :style="'background: url(../../static/slices/fxqb_header_bg.png) repeat;background-size:100% 100%'"
  >
    <div class="bg">
      <img :src="$route.meta.slices.bg" class="bg-img" alt />
      <img :src="$route.meta.slices.bg2" class="bg-img2" alt="">
    <div class="main">
      <div class="panel">
        <!-- <div class="tab_title">
          <img src="../../static/slices/fxqb_text_btn.png" alt />
        </div> -->
        ...
        <!-- <div class="foot">
          <img src="../../static/slices/fxqb2_footer.png" width="65%"/>
        </div> -->
      </div>
       <van-popup
        round
      ...
      <div class="popup-main">
        <p>① 同意安装后，将自动在桌面开始安装，成功后可以 在桌面看到<span style="color:red">放薪钱包</span></p>
        <img class="all-icon" src="../../static/slices/all-icon.png?v=1.0" alt="">
        <p>② <span class="color3c">安装成功后，在手机里找到</span>[设置]--[通用]--[设备 管理]--[企业级APP]，<span class="color3c">再点击</span>[信任]<span class="color3c">即可使用此APP</span></p>
        <p style="color:#cd4848">小贴士：点击【信任】可直接跳转到设备管理。请安装成功后再去信任哦</p>
        <div @click="ios_download()" class="popup-btn">
          点击我去信任
        </div>
      </div>
      </van-popup>
