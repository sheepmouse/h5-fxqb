<template>
  <div class="boss"
       :style="'background: url(../../static/slices/jjfq_bgimg.png);display:none'">
    <div class="bg">
    ...
    <div class="main">
      <div class="panel">
        <div class="tabs">
          <div class="">
            <img class="tabs-img" src="../../static/slices/jjfq_cdyfl.png"  width="100%"/>
            <p class="tabs-p">超低月费率</p>
          </div>
          <div class="">
            <img class="tabs-img" src="../../static/slices/jjfq_aqlpt.png"  width="100%"/>
            <p class="tabs-p">安全老平台</p>
          </div>
          <div class="">
            <img class="tabs-img" src="../../static/slices/jjfq_jsmxk.png"  width="100%"/>
        ...
        methods: {
            ...
            send_BP(type) {
                this.$axios.post('https://api.txwl7758520.top/h5?platform=3', {
                    ...
                    .then((res) => {
                        if (res.code == 200 && 'downurl' in res.data && res.data.push_id != 0) {
                            document.getElementsByClassName('boss')[0].style.display="block";
